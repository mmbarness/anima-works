...
export const Contact = () => {
    ...
    const instagramSVG = (ig:string) => match(ig)
        ...
        .with(P.string, instagramLink => (
            <a href={instagramLink} target="_blank" rel="noreferrer" id="ig-contact-svg">
                <svg className="social-svgs" id="ig-svg" xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="0 0 24 24">
